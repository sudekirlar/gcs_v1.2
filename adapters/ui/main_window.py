...
class MainWindow(QMainWindow):
    """
    View + Controller wiring (GCS + Kamera).
    """
    ...
    def __init__(
        ...
        camera_adapter,             # OpenCVAdapter (ICameraPort)
        logger,
        settings: Settings,
        parent=None
    ):
        ...
        # -------- Map placeholder → gerçek QWebEngineView --------
        ...
        self.cmd_ctrl = CommandController(
            self.ui, core, logger, parent=self
        )

        # ---- MapController gerçek mapView ile ----
