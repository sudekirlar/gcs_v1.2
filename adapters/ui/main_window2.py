...
# Tek tema: Klasik
from newTeam import Ui_MainWindow
...
class MainWindow(QMainWindow):
    """
    View + Controller wiring (GCS + Kamera + Mobil) using only the "Klasik" theme.
    """
